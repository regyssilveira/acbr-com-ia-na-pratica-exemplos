...
|---|---|---|
| descoberta | router, tabela por tarefa, tabela por família e doze receitas | forte |
...
| componentes | treze referências em seis famílias | boa para o núcleo priorizado |
...
| distribuição | pastas copiáveis e compatibilidade documentada | adequada, ainda manual |
...
4. Adicionar receitas para certificado/provider SSL, NFSe por município/provider, DANFE/relatórios e contingência.
5. Oferecer instalação e atualização das skills por script com modo `-WhatIf`, mantendo a cópia manual documentada.
